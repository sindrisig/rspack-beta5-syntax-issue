"use strict";
(self["webpackChunkexample_builtin_swc_loader"] = self["webpackChunkexample_builtin_swc_loader"] || []).push([[535],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  refreshFeatureFlags: () => (/* binding */ refreshFeatureFlags)
});
...
var FeatureFlag = /*#__PURE__*/ function() {
    ...
    _create_class(FeatureFlag, [
        ...
        },
        {
            key: "Pe",
            value: function Pe(t) {
                logger/* default */.A.info("Property is not of type ".concat(t, "."));
            }
        },
        {
            key: "ye",
            value: function ye(t) {
                logger/* default */.A.info("".concat(t, " not found in feature flag properties."));
            }
        },
        {
            key: "be",
...
function newFeatureFlagFromJson(e) {
    if (e[FeatureFlag.Rt.ht] && "boolean" == typeof e[FeatureFlag.Rt.le]) return new FeatureFlag(e[FeatureFlag.Rt.ht], e[FeatureFlag.Rt.le], e[FeatureFlag.Rt.pe], e[FeatureFlag.Rt.Fe]);
    logger/* default */.A.info("Unable to create feature flag from ".concat(JSON.stringify(e, null, 2)));
}
function newFeatureFlagFromSerializedValue(e) {
    if (e[FeatureFlag.tt.ht] && "boolean" == typeof e[FeatureFlag.tt.le]) return new FeatureFlag(e[FeatureFlag.tt.ht], e[FeatureFlag.tt.le], e[FeatureFlag.tt.pe], e[FeatureFlag.tt.Fe]);
    logger/* default */.A.info("Unable to deserialize feature flag from ".concat(JSON.stringify(e, null, 2)));
}
...
var er = /*#__PURE__*/ function(y) {
    ...
    function er(t, s, i, r) {
        ...
        var _this;
        _this = _super.call(this), _this.yt = t, _this.qt = s, _this.u = i, _this.ri = r, _this.hi = [], _this.oi = 0, _this.yt = t, _this.qt = s, _this.u = i, _this.ri = r, _this.ai = null, _this.ni = new subscription_manager/* default */.A(), _this.li = 10, _this.ui = null, _this.fi = null, braze_instance/* default */.Ay.$t(_this.ni);
    ...
    feature_flags_provider_create_class(er, [
        ...
        },
        {
            ...
            value: function mi() {
                var t = {};
                this.u && (t = this.u.j(storage_manager/* STORAGE_KEYS */.d.C.gi));
                var s = {};
                for(var i in t){
        ...
        },
        {
            ...
            value: function Fi() {
                var t;
                return (null === (t = this.u) || void 0 === t ? void 0 : t.j(storage_manager/* STORAGE_KEYS */.d.C.vi)) || {};
            }
        },
        {
            key: "pi",
            value: function pi(t) {
                this.u && this.u.k(storage_manager/* STORAGE_KEYS */.d.C.vi, t);
            }
        },
        {
            key: "Zs",
        ...
        },
        {
            ...
            value: function refreshFeatureFlags(t, s) {
                ...
                if (!h) return void r();
                e && this.yi();
                var o = h.Js({}, !0), a = h.$s(o, request_header_utils/* default */.A.Ps.bi);
                var n = !1;
                h.Xs(o, function() {
                    var h = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : -1;
                    if (!_this1.qt) return void r();
                    var l = new Date().valueOf();
                    request_header_utils/* default */.A._s(_this1.u, request_header_utils/* default */.A.Ps.bi, l), -1 !== h && a.push([
                        ...
                        L: function(s) {
                            ...
                            _this1.qt.Os(), _this1.Ns(s), n = !1, request_header_utils/* default */.A.Qs(_this1.u, request_header_utils/* default */.A.Ps.bi, 1), "function" == typeof t && t();
                        },
                        error: function(t) {
                        ...
                        Ws: function() {
                            if (e && n && !_this1.fi) {
                                request_header_utils/* default */.A.Ys(_this1.u, request_header_utils/* default */.A.Ps.bi);
                                var e1 = _this1.ui;
                                (null == e1 || e1 < 1e3 * _this1.li) && (e1 = 1e3 * _this1.li), _this1.Ci(Math.min(3e5, (0,math/* randomInclusive */.C)(1e3 * _this1.li, 3 * e1)), t, s, i);
                            }
                        }
                    });
                }, request_header_utils/* default */.A.Ps.bi, s);
            }
        },
        {
            key: "yi",
        ...
        },
        {
            ...
            value: function wi(t) {
                ...
                if (!t) {
                    ...
                    var s = !1;
                    if (!isNaN(_$t)) {
                        if (-1 === _$t) return logger/* default */.A.info("Feature flag refreshes not allowed"), !1;
                        s = new Date().getTime() >= (this.oi || 0) + 1e3 * _$t;
                    }
                    if (!s) return logger/* default */.A.info("Feature flag refreshes were rate limited to ".concat(_$t, " seconds")), !1;
                }
                return this.yt.ci();
            }
        },
        {
            ...
            value: function Ti() {
                var t;
                return (null === (t = this.u) || void 0 === t ? void 0 : t.j(storage_manager/* STORAGE_KEYS */.d.C.Di)) || null;
            }
        },
        {
            key: "Ii",
            value: function Ii() {
                var t, s;
                null === (t = this.u) || void 0 === t || t.k(storage_manager/* STORAGE_KEYS */.d.C.Di, null === (s = this.ri) || void 0 === s ? void 0 : s.Si());
            }
        },
        {
            key: "qi",
        ...
        },
        {
            ...
            value: function di() {
                ...
                this.u.k(storage_manager/* STORAGE_KEYS */.d.C.gi, t), this.u.k(storage_manager/* STORAGE_KEYS */.d.C.xi, this.oi), this.Ii();
            }
        }
    ]);
    return er;
...
var ir = {
    ...
    provider: null,
    rr: function() {
        return ir.o(), ir.provider || (ir.provider = new er(braze_instance/* default */.Ay.ir(), braze_instance/* default */.Ay.nr(), braze_instance/* default */.Ay.l(), braze_instance/* default */.Ay.zr()), braze_instance/* default */.Ay.ar(ir.provider)), ir.provider;
    },
    o: function() {
        ir.t || (braze_instance/* default */.Ay.g(ir), ir.t = !0);
    },
    destroy: function() {
...
function tr(r, t) {
    ...
    if (braze_instance/* default */.Ay.X()) return feature_flags_provider_factory.rr().refreshFeatureFlags(r, t, a);
}
