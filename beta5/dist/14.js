"use strict";
(self['webpackChunkexample_builtin_swc_loader'] = self['webpackChunkexample_builtin_swc_loader'] || []).push([["14"], {
"5680": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
    ...
    _create_class(Card, [
        ...
        },
        {
            ...
            value: function dismissCard() {
                ...
                }, constants/* FEED_ANIMATION_DURATION */.rF));
            }
        },
        {
            key: "Nt",
            value: function Nt() {
                return null == this.Et && (this.Et = new subscription_manager/* default */.Z()), this.Et;
            }
        },
        {
            key: "St",
            value: function St() {
                return null == this.Tt && (this.Tt = new subscription_manager/* default */.Z()), this.Tt;
            }
        },
        {
            key: "K",
        ...
        },
        {
            ...
            value: function Ct(t) {
                ...
                if (null != t[Card.Rt.nt] && null != this.updated && parseInt(t[Card.Rt.nt]) < (0,date_utils/* convertMsToSeconds */.FX)(this.updated.valueOf())) return !0;
                if (t[Card.Rt.et] && !this.viewed && (this.viewed = !0), t[Card.Rt.zt] && !this.clicked && (this.clicked = t[Card.Rt.zt]), null != t[Card.Rt.rt] && (this.title = t[Card.Rt.rt]), null != t[Card.Rt.ot] && (this.imageUrl = t[Card.Rt.ot]), null != t[Card.Rt.ct] && (this.description = t[Card.Rt.ct]), null != t[Card.Rt.nt]) {
                    var i = (0,date_utils/* dateFromUnixTimestamp */.X2)(t[Card.Rt.nt]);
                    null != i && (this.updated = i);
                }
                if (null != t[Card.Rt.lt]) {
                    var i1;
                    i1 = t[Card.Rt.lt] === Card._t ? null : (0,date_utils/* dateFromUnixTimestamp */.X2)(t[Card.Rt.lt]), this.expiresAt = i1;
                }
        ...
        },
        {
            key: "Y",
            value: function Y() {
                logger/* default,error */.Z.error("Must be implemented in a subclass");
            }
        }
    ]);
    return Card;
...
var control_card_ControlCard = /*#__PURE__*/ function(Card1) {
    "use strict";
...
var base_feed_x = /*#__PURE__*/ function() {
    "use strict";
    function x(s, e) {
            ...
            value: function getUnreadCardCount() {
                ...
                try {
                    for(var _iterator = this.cards[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                        var e = _step.value;
                        e.viewed || _instanceof(e, control_card_ControlCard) || s++;
                    }
                } catch (err) {
...
base_feed_x.ur = 6e4, base_feed_x.Ah = 500, base_feed_x.Co = 1e4;
...
var card_manager_a = /*#__PURE__*/ function() {
    "use strict";
    function a(s) {
    ...
    card_manager_create_class(a, [
        {
            ...
            value: function h(n, e) {
                ...
                if (n.p(), null == n.url || "" === n.url) return logger/* default,info */.Z.info("Card ".concat(n.id, " has no url. Not logging click to Braze servers.")), l;
                if (e && n.id && this.u) {
                    var _$s = this.u.j(storage_manager/* STORAGE_KEYS,C,v */.I.C.v) || {};
                    _$s[n.id] = !0, this.u.k(storage_manager/* STORAGE_KEYS,C,v */.I.C.v, _$s);
                }
                var u = this.D([
                    n
                ]);
                if (null == u) return l;
                var c = e ? event_types/* EventTypes,I */.G.I : event_types/* EventTypes,$ */.G.$;
                return event_logger/* default,q */.Z.q(c, u);
            }
        },
        {
            key: "B",
            value: function B(n) {
                var e = new request_result/* default */.Z();
                if (!n.N()) return logger/* default,info */.Z.info("Card ".concat(n.id, " refused this dismissal. Ignoring analytics event.")), e;
                if (n.id && this.u) {
                    var _$s = this.u.j(storage_manager/* STORAGE_KEYS,C,A */.I.C.A) || {};
                    _$s[n.id] = !0, this.u.k(storage_manager/* STORAGE_KEYS,C,A */.I.C.A, _$s);
                }
                var l = this.D([
                    n
                ]);
                return null == l ? e : event_logger/* default,q */.Z.q(event_types/* EventTypes,F */.G.F, l);
            }
        },
        {
            key: "G",
            value: function G(n, r) {
                var e = new request_result/* default */.Z(!0), l = [], u = [];
                var c = {};
                this.u && (c = r ? this.u.j(storage_manager/* STORAGE_KEYS,C,H */.I.C.H) || {} : this.u.j(storage_manager/* STORAGE_KEYS,C,J */.I.C.J) || {});
                var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                try {
                    for(var _iterator = n[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                        var _$s = _step.value;
                        _$s.K(), card_manager_instanceof(_$s, control_card_ControlCard) ? u.push(_$s) : l.push(_$s), _$s.id && (c[_$s.id] = !0);
                    }
                } catch (err) {
                    _didIteratorError = true;
                    _iteratorError = err;
                ...
                if (this.u && (r ? this.u.k(storage_manager/* STORAGE_KEYS,C,H */.I.C.H, c) : this.u.k(storage_manager/* STORAGE_KEYS,C,J */.I.C.J, c)), null != h) {
                    var _$t = r ? event_types/* EventTypes,M */.G.M : event_types/* EventTypes,O */.G.O, _$n = event_logger/* default,q */.Z.q(_$t, h);
                    e.P(_$n);
                }
                if (null != _$a && r) {
                    var _$t1 = event_logger/* default,q */.Z.q(event_types/* EventTypes,R */.G.R, _$a);
                    e.P(_$t1);
                }
                return e;
            }
...
var card_manager_factory_n = {
    t: !1,
    i: null,
    m: function() {
        return card_manager_factory_n.o(), card_manager_factory_n.i || (card_manager_factory_n.i = new card_manager_a(braze_instance/* default,l */.ZP.l())), card_manager_factory_n.i;
    },
    o: function() {
        card_manager_factory_n.t || (braze_instance/* default,g */.ZP.g(card_manager_factory_n), card_manager_factory_n.t = !0);
    },
    destroy: function() {
        card_manager_factory_n.i = null, card_manager_factory_n.t = !1;
    }
};
/* harmony default export */ const card_manager_factory = (card_manager_factory_n);
...
function logCardDismissal(o) {
    return !!braze_instance/* default,X */.ZP.X() && (log_card_dismissal_instanceof(o, card_Card) ? card_manager_factory.m().B(o).L : (logger/* default,error */.Z.error("card " + constants/* MUST_BE_CARD_WARNING_SUFFIX */.U4), !1));
}
...
function cardToHtml(t, logCardClick, o) {
    ...
    var r = function(e) {
        return markCardAsRead(a), i && (logCardClick(t), (0,handle_braze_action/* _handleBrazeAction */.S)(n, o, e)), !1;
    };
    if (t.pinned) {
    ...
    if (s.className = "ab-card-body", s.dir = e, t.dismissible) {
        ...
        var o3 = (0,component_utils/* createCloseButton */.B)("Dismiss Card", void 0, t.dismissCard.bind(t), e);
        a.appendChild(o3), (0,dom_utils/* detectSwipe */.FZ)(s, dom_utils/* DIRECTIONS,U */.mQ.U, function(t) {
            a.className += " ab-swiped-left", o3.onclick(t);
        }), (0,dom_utils/* detectSwipe */.FZ)(s, dom_utils/* DIRECTIONS,V */.mQ.V, function(t) {
    ...
    if (t.title && "" !== t.title && (l = t.title, b = !0), b) {
        ...
        if (_$t2.className = "ab-title", _$t2.id = guid/* default,W */.Z.W(), a.setAttribute("aria-labelledby", _$t2.id), i) {
    ...
    if (f.className = b ? "ab-description" : "ab-description ab-no-title", f.id = guid/* default,W */.Z.W(), a.setAttribute("aria-describedby", f.id), t.description && f.appendChild(document.createTextNode(t.description)), i) {
...
function remove_subscription_removeSubscription(r) {
    braze_instance/* default,X */.ZP.X() && braze_instance/* default,removeSubscription */.ZP.removeSubscription(r);
}
...
function destroyFeedHtml(e) {
    ...
    null != t && remove_subscription_removeSubscription(t);
...
function generateFeedBody(e, t) {
    var o = l10n_manager_factory/* default,m */.Z.m(), s = document.createElement("div");
    if (s.className = "ab-feed-body", s.setAttribute("aria-label", "Feed"), s.setAttribute("role", "feed"), null == e.lastUpdated) {
        ...
        try {
            for(var _iterator = e.cards[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                var i = _step.value;
                var a = feed_display_instanceof(i, control_card_ControlCard);
                !a || e.dr() ? (s.appendChild(cardToHtml(i, logCardClick, t, o.wo())), n = n || !a) : logger/* default,error */.Z.error("Received a control card for a legacy news feed. Control cards are only supported with content cards.");
            }
        } catch (err) {
            _didIteratorError = true;
            _iteratorError = err;
...
function detectFeedImpressions(e, t) {
    if (null != e && null != t) {
        ...
        for(var _$t = 0; _$t < s.length; _$t++){
            var n = getCardId(s[_$t]), r = (0,dom_utils/* topIsInView */.rJ)(s[_$t]), i = (0,dom_utils/* bottomIsInView */.Fr)(s[_$t]);
            if (e.yo[n]) {
    ...
    t.setAttribute("data-last-requested-refresh", s), setTimeout(function() {
        if (t.getAttribute("data-last-requested-refresh") === s) {
            ...
            if (null != o) {
                ...
                _$e1.innerHTML = l10n_manager_factory/* default,m */.Z.m().get("FEED_TIMEOUT_MESSAGE") || "", null != o.parentNode && (o.parentNode.appendChild(_$e1), o.parentNode.removeChild(o));
            }
...
function feedToHtml(e, t, o) {
    ...
    r.addEventListener("keydown", function(e) {
        e.keyCode !== key_codes/* KeyCodes,Fo */.m.Fo && e.keyCode !== key_codes/* KeyCodes,To */.m.To || i(e);
    }), r.onclick = i;
    ...
    a.addEventListener("keydown", function(e) {
        e.keyCode !== key_codes/* KeyCodes,Fo */.m.Fo && e.keyCode !== key_codes/* KeyCodes,To */.m.To || d(e);
    ...
    try {
        for(var _iterator = t[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            ...
            if (feed_display_instanceof(_$e, card_Card)) {
                if (_$e.url && validation_utils/* BRAZE_ACTION_URI_REGEX,test */.y9.test(_$e.url)) {
                    var _$t = (0,braze_actions/* getDecodedBrazeAction */.OL)(_$e.url);
                    if ((0,braze_actions/* containsUnknownBrazeAction */.je)(_$t)) {
                        logger/* default,error */.Z.error((0,braze_actions/* ineligibleBrazeActionURLErrorMessage */.Tu)(braze_actions/* INELIGIBLE_BRAZE_ACTION_URL_ERROR_TYPES,Li */.yi.Li, "Content Card"));
                        continue;
                    }
                }
                i.push(_$e);
...
function log_card_impressions_logCardImpressions(o, s) {
    if (!braze_instance/* default,X */.ZP.X()) return !1;
    if (!(0,code_utils/* isArray */.kJ)(o)) return logger/* default,error */.Z.error("cards must be an array"), !1;
    var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
    try {
        for(var _iterator = o[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            var _$n = _step.value;
            if (!log_card_impressions_instanceof(_$n, card_Card)) return logger/* default,error */.Z.error("Each card in cards ".concat(constants/* MUST_BE_CARD_WARNING_SUFFIX */.U4)), !1;
        }
    } catch (err) {
        _didIteratorError = true;
        _iteratorError = err;
...
function log_card_click_logCardClick(o, m) {
    return !!braze_instance/* default,X */.ZP.X() && (log_card_click_instanceof(o, card_Card) ? card_manager_factory.m().h(o, m).L : (logger/* default,error */.Z.error("card " + constants/* MUST_BE_CARD_WARNING_SUFFIX */.U4), !1));
}
...
var classic_card_ClassicCard = /*#__PURE__*/ function(Card1) {
    "use strict";
...
var captioned_image_CaptionedImage = /*#__PURE__*/ function(Card1) {
    "use strict";
...
var image_only_ImageOnly = /*#__PURE__*/ function(Card1) {
    "use strict";
...
function newCard(n, e, t, o, i, l, u, d, a, w, f, s, m, C, p, c, x, F) {
    var j;
    if (e === card_Card.it.Ot || e === card_Card.it.Mt) j = new classic_card_ClassicCard(n, t, o, i, l, u, d, a, w, f, s, m, C, p, c, x);
    else if (e === card_Card.it.st) j = new captioned_image_CaptionedImage(n, t, o, i, l, u, d, a, w, f, s, m, C, p, c, x);
    else if (e === card_Card.it.Pt) j = new image_only_ImageOnly(n, t, i, u, d, a, w, f, s, m, C, p, c, x);
    else {
        if (e !== card_Card.it.Ut) return logger/* default,error */.Z.error("Ignoring card with unknown type " + e), null;
        j = new control_card_ControlCard(n, t, d, w, C, p);
    }
    return F && (j.test = F), j;
}
...
function newCardFromFeedJson(n) {
    return newCard(n.id, n.type, n.viewed, n.title, n.image, n.description, (0,date_utils/* dateFromUnixTimestamp */.X2)(n.created), (0,date_utils/* dateFromUnixTimestamp */.X2)(n.updated), n.categories, (0,date_utils/* dateFromUnixTimestamp */.X2)(n.expires_at), n.url, n.domain, n.aspect_ratio, n.extras, !1, !1);
}
function newCardFromSerializedValue(n) {
    return newCard(n[card_Card.tt.ht], n[card_Card.tt.Z], n[card_Card.tt.et], n[card_Card.tt.rt], n[card_Card.tt.ot], n[card_Card.tt.ct], (0,date_utils/* rehydrateDateAfterJsonization */.Rd)(n[card_Card.tt.dt]), (0,date_utils/* rehydrateDateAfterJsonization */.Rd)(n[card_Card.tt.nt]), n[card_Card.tt.ut], (0,date_utils/* rehydrateDateAfterJsonization */.Rd)(n[card_Card.tt.lt]), n[card_Card.tt.URL], n[card_Card.tt.ft], n[card_Card.tt.xt], n[card_Card.tt.bt], n[card_Card.tt.gt], n[card_Card.tt.jt], n[card_Card.tt.zt], n[card_Card.tt.kt] || !1) || void 0;
}
...
var feed_provider_ee = /*#__PURE__*/ function(y) {
    "use strict";
    ...
    function ee(t, s) {
        ...
        var _this;
        _this = _super.call(this), _this.u = t, _this.zi = s, _this.cards = [], _this.Ni = null, _this.u = t, _this.zi = s, _this.Jt = new subscription_manager/* default */.Z(), braze_instance/* default,$t */.ZP.$t(_this.Jt), _this.Kt();
    ...
    feed_provider_create_class(ee, [
        {
            ...
            value: function Kt() {
                var t = [];
                this.u && (t = this.u.j(storage_manager/* STORAGE_KEYS,C,Ui */.I.C.Ui) || []);
                var s = [];
                for(var i = 0; i < t.length; i++){
                    var e = newCardFromSerializedValue(t[i]);
                    null != e && s.push(e);
                }
                this.cards = s, this.u && (this.Ni = (0,date_utils/* rehydrateDateAfterJsonization */.Rd)(this.u.j(storage_manager/* STORAGE_KEYS,C,ki */.I.C.ki)));
            }
        },
        {
            key: "Ai",
            value: function Ai(t) {
                var s = [];
                var i = null, e = {};
                this.u && (e = this.u.j(storage_manager/* STORAGE_KEYS,C,J */.I.C.J) || {});
                var r = {};
                ...
                this.cards = s, this.Rs(), this.Ni = new Date(), this.u && (this.u.k(storage_manager/* STORAGE_KEYS,C,J */.I.C.J, r), this.u.k(storage_manager/* STORAGE_KEYS,C,ki */.I.C.ki, this.Ni));
            }
        },
        {
            key: "Rs",
            value: function Rs() {
                ...
                null === (t = this.u) || void 0 === t || t.k(storage_manager/* STORAGE_KEYS,C,Ui */.I.C.Ui, s);
            }
        },
        {
            key: "Ns",
            value: function Ns(t) {
                null != t && t.feed && (this.Kt(), this.Ai(t.feed), this.Jt.Dt(new feed_Feed(this.cards.slice(), this.Ni)));
            }
        },
        {
            key: "Bi",
            value: function Bi() {
                ...
                return new feed_Feed(t, this.Ni);
            }
        },
        {
            key: "xs",
        ...
        },
        {
            ...
            value: function clearData(t) {
                null == t && (t = !1), this.cards = [], this.Ni = null, t && this.u && (this.u.ti(storage_manager/* STORAGE_KEYS,C,Ui */.I.C.Ui), this.u.ti(storage_manager/* STORAGE_KEYS,C,ki */.I.C.ki)), this.Jt.Dt(new feed_Feed(this.cards.slice(), this.Ni));
            }
        }
    ]);
    return ee;
...
var re = {
    ...
    provider: null,
    rr: function() {
        return re.o(), re.provider || (re.provider = new feed_provider_ee(braze_instance/* default,l */.ZP.l(), braze_instance/* default,cr */.ZP.cr()), braze_instance/* default,ar */.ZP.ar(re.provider)), re.provider;
    },
    o: function() {
        re.t || (braze_instance/* default,g */.ZP.g(re), re.t = !0);
    },
    destroy: function() {
...
function requestFeedRefresh() {
    if (braze_instance/* default,X */.ZP.X()) return feed_provider_factory.rr().xs();
}
...
var feed_Feed = /*#__PURE__*/ function(x) {
    "use strict";
    ...
    feed_create_class(Feed, [
        {
            ...
            value: function logCardImpressions1(r) {
                log_card_impressions_logCardImpressions(r, !1);
            }
        },
        {
            key: "logCardClick",
            value: function logCardClick1(r) {
                return log_card_click_logCardClick(r, !1);
            }
        },
        {
            key: "sr",
...
function subscribeToFeedUpdates(r) {
    if (braze_instance/* default,X */.ZP.X()) return feed_provider_factory.rr().Zs(r);
}
...
function logFeedDisplayed() {
    var r;
    if (braze_instance/* default,X */.ZP.X()) return null === (r = braze_instance/* default,nr */.ZP.nr()) || void 0 === r ? void 0 : r.qr(event_types/* InternalEventTypes,Ar */.r.Ar).L;
}
...
function showFeed(t, n, o) {
    ...
    var i = function(e, t) {
        ...
        for(var _$t = 0; _$t < e.length; _$t++){
            ...
            (0,code_utils/* intersection */.jV)(_$r, _$n).length > 0 && _$o.push(e[_$t]);
        }
        return _$o;
    }, s = braze_instance/* default,nn */.ZP.nn(braze_instance/* OPTIONS,tn */.JY.tn) || braze_instance/* default,nn */.ZP.nn(braze_instance/* OPTIONS,en */.JY.en) || !1;
    var l = !1;
    null == t && (t = document.body, l = !0);
    var f, a = !1;
    null == n ? (f = feed_provider_factory.rr().Bi(), updateFeedCards(f, i(f.cards, o), f.lastUpdated, null, s), a = !0) : f = new feed_Feed(i(n, o), new Date());
    var u = feedToHtml(f, s, l);
    if (a) {
        (null == f.lastUpdated || new Date().valueOf() - f.lastUpdated.valueOf() > feed_Feed.ur) && (logger/* default,info */.Z.info("Cached feed was older than max TTL of ".concat(feed_Feed.ur, " ms, requesting an update from the server.")), refreshFeed(f, u));
